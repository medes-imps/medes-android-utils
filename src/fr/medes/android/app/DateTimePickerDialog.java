...
public class DateTimePickerDialog extends AlertDialog implements OnClickListener, OnCheckedChangeListener,
	...
	public DateTimePickerDialog(Context context, int theme, OnDateTimeSetListener callBack, int year, int monthOfYear,
		...
		View view = inflater.inflate(R.layout.aml__date_time_picker_dialog, null);
		setView(view);
		...
		mSwitcher = (CheckBox) view.findViewById(R.id.aml__switchDateTime);
	...
	// */
	// TextView title = (TextView) findViewById(android.R.id.aml__title);
	// title.setSingleLine();
