...
public abstract class QuickActionWidget extends PopupWindow {
    ...
    private void prepareAnimationStyle() {
        ...
        if (arrowPointX <= screenWidth / 4) {
            setAnimationStyle(onTop ? R.style.Medes_Animation_PopUp_Left
                    : R.style.Medes_Animation_PopDown_Left);
        } else if (arrowPointX >= 3 * screenWidth / 4) {
            setAnimationStyle(onTop ? R.style.Medes_Animation_PopUp_Right
                    : R.style.Medes_Animation_PopDown_Right);
        } else {
            setAnimationStyle(onTop ? R.style.Medes_Animation_PopUp_Center
                    : R.style.Medes_Animation_PopDown_Center);
        }
    }
