...
/**
 * A QuickActionBar displays a set of {@link QuickAction} on a single row. In case too many items are added to the
 * QuickActionBar, the user can horizontally scroll {@link QuickAction}s. Using a QuickActionBar is a great replacement
 * for the long click UI pattern. For instance, {@link QuickActionBar} adds secondary actions to an item of a ListView.
 * 
...
public class QuickActionBar extends QuickActionWidget {
	...
	public QuickActionBar(Context context) {
		...
		mRackAnimation = AnimationUtils.loadAnimation(context, R.anim.aml__rack);
		...
		setContentView(R.layout.aml__quick_action_bar);

		final View v = getContentView();
		mRack = (ViewGroup) v.findViewById(R.id.aml__rack);
		mQuickActionItems = (ViewGroup) v.findViewById(R.id.aml__quick_action_items);
		mScrollView = (HorizontalScrollView) v.findViewById(R.id.aml__scroll);
	}
	...
	protected void populateQuickActions(List<QuickAction> quickActions) {
		...
		for (QuickAction action : quickActions) {
			TextView view = (TextView) inflater.inflate(R.layout.aml__quick_action_bar_item, mQuickActionItems, false);
