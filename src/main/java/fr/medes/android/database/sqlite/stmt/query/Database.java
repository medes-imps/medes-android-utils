...
/**
 * Database Helper class providing methods to ease the construction of SQL statements.
 * 
 * @author Medes-IMPS
 * 
 */
public class Database {
	 ...
	 * @param column The column name where the max statement should be performed.
	 */
