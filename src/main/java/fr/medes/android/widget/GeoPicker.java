...
public class GeoPicker extends ScrollView {
	...
	private final OnClickListener mOnClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			if (v.getId() == R.id.aml__northSouth) {
				setNorth(!mNorth);
			} else if (v.getId() == R.id.aml__eastWest) {
				setEast(!mEast);
			}
		}
	};
	...
	public GeoPicker(Context context, AttributeSet attrs, int defStyle) {
		...
		inflate(context, R.layout.aml__geo_picker, this);

		mNorthSouthButton = (Button) findViewById(R.id.aml__northSouth);
		mLatDegreeView = (TextView) findViewById(R.id.aml__latDegree);
		mLatMinuteView = (TextView) findViewById(R.id.aml__latMinute);
		mLatSecondView = (TextView) findViewById(R.id.aml__latSecond);
		mLatDecimalView = (TextView) findViewById(R.id.aml__latDecimal);
		mEastWestButton = (Button) findViewById(R.id.aml__eastWest);
		mLonDegreeView = (TextView) findViewById(R.id.aml__lonDegree);
		mLonMinuteView = (TextView) findViewById(R.id.aml__lonMinute);
		mLonSecondView = (TextView) findViewById(R.id.aml__lonSecond);
		mLonDecimalView = (TextView) findViewById(R.id.aml__lonDecimal);
		mFormatCheckBox = (CheckBox) findViewById(R.id.aml__geoFormat);
	...
	public void setNorth(boolean north) {
		mNorth = north;
		mNorthSouthButton.setText(north ? R.string.aml__north : R.string.aml__south);
		if (!mIsDecimal) {
	...
	public void setEast(boolean east) {
		mEast = east;
		mEastWestButton.setText(east ? R.string.aml__east : R.string.aml__west);
		if (!mIsDecimal) {
	...
	private final class MyTextWatcher implements TextWatcher {
		...
		public void afterTextChanged(Editable s) {
			...
			if (v != null) {
				...
				if (id == R.id.aml__latDegree || id == R.id.aml__latMinute || id == R.id.aml__latSecond) {
					onLatDegreeValueChanged();
				} else if (id == R.id.aml__latDecimal) {
					onLatDecimalValueChanged();
				} else if (id == R.id.aml__lonDegree || id == R.id.aml__lonMinute || id == R.id.aml__lonSecond) {
					onLonDegreeValueChanged();
				} else if (id == R.id.aml__lonDecimal) {
