...
public class QuickActionGrid extends QuickActionWidget {
	...
	public QuickActionGrid(Context context) {
		...
		setContentView(R.layout.aml__quick_action_grid);

		final View v = getContentView();
		mGridView = (GridView) v.findViewById(R.id.aml__grid);
	}
		...
		mGridView.setAdapter(new BaseAdapter() {
			...
			public View getView(int position, View view, ViewGroup parent) {
				...
				if (view == null) {
					...
					textView = (TextView) inflater.inflate(R.layout.aml__quick_action_grid_item, mGridView, false);
				}
